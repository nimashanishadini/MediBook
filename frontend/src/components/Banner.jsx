...
const navigate = useNavigate()
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
      ...
      <button onClick={() => {navigate('/login'); scroll(0,0)}}  className='bg-white text-sm sm:text-base text-gray-600 px-8 py-3 rounded-full mt-6 hover-scale-105 transition-all'>
        Create Account
      </button>
      </div>
